...
class PastAnniversaryAdapter(
    val context: Context,
    /*private val mList: ArrayList<UpcomingAnniversary>,*/
    private val onItemClickListener: PastAnniversaryDetailAdapter.ClickListener
): RecyclerView.Adapter<PastAnniversaryAdapter.ViewHolder>() {

    lateinit var binding: ItemUpcomingAnniversaryBinding
    private lateinit var adapter: PastAnniversaryDetailAdapter
...
//        adapter = PastAnniversaryDetailAdapter(, /*mList[position].detail*/)
