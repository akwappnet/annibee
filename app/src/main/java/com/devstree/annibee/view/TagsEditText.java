...
public class TagsEditText extends androidx.appcompat.widget.AppCompatAutoCompleteTextView {
    ...
    public static final String JAP_NEW_LINE = "，";
    public static final String JAP1_NEW_LINE = "、";
    ...
    private final TextWatcher mTextWatcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            char lastChar=s.toString().length() >0 ? s.toString().charAt(s.toString().length()-1):0;
            if(s.toString().contains(JAP_NEW_LINE)){
                NEW_LINE=JAP_NEW_LINE;
            }else  if(s.toString().contains(JAP1_NEW_LINE)){
                NEW_LINE=JAP1_NEW_LINE;
            }else  if(s.toString().contains(NEW_LINE) || String.valueOf(lastChar).equals(",")){
                NEW_LINE=",";
            }

            //Log.e("@TAg","onTextChanged::"+lastChar+":: "+NEW_LINE+" :: "+count+"__"+s.toString().length());
        }
   ...
   /* @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    ...
    /**
     * Use this method for create tag from string
     *
     * @param string which is end with "," or separator link \n or , or . etc.
     */
    ...
    public void convertStringToTagSpan(String str) {

        if (str == null) return;

        List<String> list = listOf(str.split(","));
    ...
    private void init(@Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (attrs == null) {
            ...
            mTagsTextColor = getColor(context, mabbas007.tagsedittext.R.color.defaultTagsTextColor);
            mTagsTextSize = ResourceUtils.getDimensionPixelSize(context, mabbas007.tagsedittext.R.dimen.defaultTagsTextSize);
            mTagsBackground = ContextCompat.getDrawable(context, mabbas007.tagsedittext.R.drawable.oval);
            mRightDrawable = ContextCompat.getDrawable(context, mabbas007.tagsedittext.R.drawable.tag_close);
            mDrawablePadding = ResourceUtils.getDimensionPixelSize(context, mabbas007.tagsedittext.R.dimen.defaultTagsCloseImagePadding);
            mTagsPaddingRight = ResourceUtils.getDimensionPixelSize(context, mabbas007.tagsedittext.R.dimen.defaultTagsPadding);
            mTagsPaddingLeft = ResourceUtils.getDimensionPixelSize(context, mabbas007.tagsedittext.R.dimen.defaultTagsPadding);
            mTagsPaddingTop = ResourceUtils.getDimensionPixelSize(context, mabbas007.tagsedittext.R.dimen.defaultTagsPadding);
            mTagsPaddingBottom = ResourceUtils.getDimensionPixelSize(context, mabbas007.tagsedittext.R.dimen.defaultTagsPadding);
        } else {
            TypedArray typedArray = context.obtainStyledAttributes(attrs, mabbas007.tagsedittext.R.styleable.TagsEditText, defStyleAttr, defStyleRes);
            try {
                mIsSpacesAllowedInTags = typedArray.getBoolean(mabbas007.tagsedittext.R.styleable.TagsEditText_allowSpaceInTag, false);
                mTagsTextColor = typedArray.getColor(mabbas007.tagsedittext.R.styleable.TagsEditText_tagsTextColor,
                        getColor(context, mabbas007.tagsedittext.R.color.defaultTagsTextColor));
                mTagsTextSize = typedArray.getDimensionPixelSize(mabbas007.tagsedittext.R.styleable.TagsEditText_tagsTextSize,
                        ResourceUtils.getDimensionPixelSize(context, mabbas007.tagsedittext.R.dimen.defaultTagsTextSize));
                mTagsBackground = typedArray.getDrawable(mabbas007.tagsedittext.R.styleable.TagsEditText_tagsBackground);
                mRightDrawable = typedArray.getDrawable(mabbas007.tagsedittext.R.styleable.TagsEditText_tagsCloseImageRight);
                mLeftDrawable = typedArray.getDrawable(mabbas007.tagsedittext.R.styleable.TagsEditText_tagsCloseImageLeft);
                mDrawablePadding = typedArray.getDimensionPixelOffset(mabbas007.tagsedittext.R.styleable.TagsEditText_tagsCloseImagePadding,
                        ResourceUtils.getDimensionPixelSize(context, mabbas007.tagsedittext.R.dimen.defaultTagsCloseImagePadding));
                mTagsPaddingRight = typedArray.getDimensionPixelSize(mabbas007.tagsedittext.R.styleable.TagsEditText_tagsPaddingRight,
                        ResourceUtils.getDimensionPixelSize(context, mabbas007.tagsedittext.R.dimen.defaultTagsPadding));
                mTagsPaddingLeft = typedArray.getDimensionPixelSize(mabbas007.tagsedittext.R.styleable.TagsEditText_tagsPaddingLeft,
                        ResourceUtils.getDimensionPixelSize(context, mabbas007.tagsedittext.R.dimen.defaultTagsPadding));
                mTagsPaddingTop = typedArray.getDimensionPixelSize(mabbas007.tagsedittext.R.styleable.TagsEditText_tagsPaddingTop,
                        ResourceUtils.getDimensionPixelSize(context, mabbas007.tagsedittext.R.dimen.defaultTagsPadding));
                mTagsPaddingBottom = typedArray.getDimensionPixelSize(mabbas007.tagsedittext.R.styleable.TagsEditText_tagsPaddingBottom,
                        ResourceUtils.getDimensionPixelSize(context, mabbas007.tagsedittext.R.dimen.defaultTagsPadding));
            } finally {
                typedArray.recycle();
            }
    ...
    static CharSequence[] convertTagSpanToArray(List<TagSpan> tagSpans) {
    ...
    public String convertTagSpanToString(List<String> tagSpans) {
        int size = tagSpans.size();
        StringBuilder values = new StringBuilder();
        for (int i = 0; i < size; i++) {
            values.append(tagSpans.get(i)).append(",");
        }
   ...
   /* public void convertStringToTagSpan(String str) {
        ...
        for (int i = 0; i < list.size(); i++) {
            if (!list.get(i).isEmpty()) {
                setTags(list.get(i), i, list.get(i).length() + 1);
            }
        }
    }*/
